...
export function StepUserAccount({ data, onNext }: StepUserAccountProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 animate-fade-in">
      ...
      <Button type="submit" className="w-full" size="lg" disabled={isSubmitting || isGoogleLoading}>
        Continue
      </Button>

      <div className="mt-6 flex items-center justify-center space-x-2">
        <span className="h-[1px] w-full bg-border"></span>
        <span className="text-xs text-muted-foreground uppercase font-medium whitespace-nowrap px-2">Or continue with</span>
        <span className="h-[1px] w-full bg-border"></span>
      </div>
