...
const bookingSchema = z.object({
  ...
  patientPhone: z.string().min(10, 'Please enter a valid phone number').max(15),
          ...
          <Card variant="elevated" className="max-w-lg mx-auto text-center animate-scale-in">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Your appointment has been booked successfully. The clinic will confirm your appointment shortly.
              </p>
              ...
              <div className="flex gap-3">
                <Button variant="outline" asChild className="flex-1">
                  <Link to="/search">Find More Clinics</Link>
                </Button>
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Fill in your details to book an appointment. No account required.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div>
            <Card variant="elevated" className="sticky top-20">
              ...
              <CardContent className="space-y-4">
                ...
                <Badge variant="pending" className="w-full justify-center py-2">
                  Payment at Clinic
                </Badge>
              </CardContent>
            </Card>
